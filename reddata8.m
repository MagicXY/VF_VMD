...
close all;
clc;
[S,F]=rdsamp('f:\Database\CUDB\cu03\cu03',[],(60*8+25)*250);
t=S((60*8+20)*250+1:end,1);
f=F((60*8+20)*250+1:end,1);
plot(t,f)
% plot(S,F)
...
%--------------- Preparation cu03部分特异性 优先基线
%结果基线震荡，dc改为1后结果优化,最后5秒特异性以及前20秒高频噪声
