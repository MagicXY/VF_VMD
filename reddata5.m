...
close all;
clc;
[S,F]=rdsamp('f:\Database\CUDB\cu03\cu03',[],(60*5+45)*250);
t=S((60*5+40)*250+1:end,1);
f=F((60*5+40)*250+1:end,1);
plot(t,f)
% plot(S,F)
...
%--------------- Preparation cu03，基线幅值较大会明显影响，基线不振荡结果较好
...
init = 0;           % initialize omegas uniformly选为0可以改善基线影响
